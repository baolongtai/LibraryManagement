...
INSERT [dbo].[BILL_DETAIL] ([BILL_ID], [STUDENT].[STUDENT.ID], [STUDENT].[STUDENT.NAME], [BOOK_ID], [BOOKS].[BOOK_NAME], [TYPE_BOOK].[TYPE_BOOK_NAME]) VALUES ('B001', 'CD185461', N'Lâm Covid-19', N'BO01', N'afđáádf', N'iọiộ')
INSERT [dbo].[BILL_DETAIL] ([BILL_ID], [STUDENT].[STUDENT.ID], [STUDENT].[STUDENT.NAME], [BOOK_ID], [BOOKS].[BOOK_NAME], [TYPE_BOOK].[TYPE_BOOK_NAME]) VALUES ('B002', 'CD185461', N'Trần Covid-20', N'BO02', N'GKHKHLIIH', N'LLJJ' )
INSERT [dbo].[BILL_DETAIL] ([BILL_ID], [STUDENT].[STUDENT.ID], [STUDENT].[STUDENT.NAME], [BOOK_ID], [BOOKS].[BOOK_NAME], [TYPE_BOOK].[TYPE_BOOK_NAME]) VALUES ('B003', 'CD185461', N'Lâm Covid-21', N'BO03', N'HKLGUY', N'JIOI' )
INSERT [dbo].[BILL_DETAIL] ([BILL_ID], [STUDENT].[STUDENT.ID], [STUDENT].[STUDENT.NAME], [BOOK_ID], [BOOKS].[BOOK_NAME], [TYPE_BOOK].[TYPE_BOOK_NAME]) VALUES ('B004', 'CD185461', N'Nguyễn Chui Ra', N'BO04', N'OIIJO', N'ỌIIỊ')
